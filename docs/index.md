...
> **⚠️ Beta notice** — this project (v0.1.2) and the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) are both in **public beta**: do not use in engineering / production environments.
...
**[→ Documentation Index](README.md)** — installation guide, porting analysis, verification report (incl. the v0.1.1 long-session battle report), and video production guide.
...
- **npm**: [billion-context-dsh@0.1.2](https://www.npmjs.com/package/billion-context-dsh)
- **Releases**: [v0.1.2](https://github.com/Tyan66666/billion-context-dsh/releases/tag/v0.1.2) · [v0.1.1](https://github.com/Tyan66666/billion-context-dsh/releases/tag/v0.1.1) · [v0.1.0](https://github.com/Tyan66666/billion-context-dsh/releases/tag/v0.1.0)
