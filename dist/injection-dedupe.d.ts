...
export declare const DEDUPE_SOURCES: readonly string[];
/** 未变引用帧：`[unchanged: sha1:<12位>]` = 38 B（远低于 60 B 上限）。 */
export declare const UNCHANGED_PREFIX = "[unchanged: sha1:";
export declare function sha1Short(text: string): string;
export declare function unchangedStub(hash: string): string;
/** 可见键：`<kind>#<sha1>`（同种来源的多份包靠哈希各自成键，不会互相顶掉）。 */
export declare function injectionKey(kind: string, hash: string): string;
 ...
 */
export declare function visibleInjectionKeys(session: SessionSurfaceLike): Set<string>;
 ...
 */
export declare function elideUnchangedInjections<T extends InjectedMessageLike>(messages: readonly T[], visible: ReadonlySet<string>): ElideResult<T>;
