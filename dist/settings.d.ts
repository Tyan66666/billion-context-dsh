...
import { type SettingsDescriptor, type SettingsProvider } from '@deepseek-ai/dsh-settings';
...
export declare const ACP_SETTINGS_NAMESPACE: import("@deepseek-ai/dsh-settings").SettingsNamespace;
